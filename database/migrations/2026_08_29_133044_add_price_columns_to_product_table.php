// database/migrations/xxxx_xx_xx_add_price_columns_to_product_table.php
<?php
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('product', function (Blueprint $table) {
            ...
            // ✅ Add food_type_id column (if not exists)
    ...
    {
        Schema::table('product', function (Blueprint $table) {
            $table->dropColumn(['last_price', 'previous_price', 'avg_price', 'food_type_id']);
        });
    }
};
